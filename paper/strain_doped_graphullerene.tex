...
Analysis using the inverse participation ratio (IPR) reveals dramatic changes in charge localization: IPR values drop from 45-50 (strongly localized, 2-3 C$_{60}$ units) to 25-30 (delocalized over 4-5 units) under optimal strain-doping conditions. The transition criterion is
\begin{equation}
...
\textbf{(i) Charge Delocalization Enhancement:} The IPR reduction from 45 to 25 indicates charge delocalization over more molecular units. This enhancement factor is:
\begin{equation}
